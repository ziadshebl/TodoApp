           ...
           children: <Widget>[
            Container(
              padding: EdgeInsets.fromLTRB(
                  10, deviceSize.height * 0.1, 10, deviceSize.height * 0.04),
              child: Hero(
                tag: 'logo',
                child: Image.asset(
                  'assets/TodoLogo.png',
            ...
            Container(
              ...
              child: FloatingActionButton(
                onPressed: () {
                 firebaseAuth.signupWithEmail(emailInputController.text, passwordInputController.text,nameInputController.text, context);
                },
